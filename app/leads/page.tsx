...
import { Users, Plus, Globe, Building2, Clock, ArrowUpRight } from "lucide-react"
  ...
  return (
    <div className="min-h-dvh">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 sm:px-6">
        <PageHeader
          title="Лиды"
          subtitle="Компании и контакты, с которыми работаем. Первый уровень — на его основе строятся анализ и письма."
          action={
            <Link
              href="/leads/new"
        ...
        {leads.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-card/50 px-6 py-12 text-center">
            ...
            <p className="mt-3 text-sm font-medium text-foreground">Пока нет ни одного лида</p>
            <p className="mt-1.5 text-sm text-muted-foreground text-pretty">
              Создай первого лида — заполни данные компании, а анализ и письма сделаем на его основе.
            </p>
            <Link
              href="/leads/new"
